...
// import LogoDark from "../DashboardComponents/";
import LogoDark from './doubtslogo.png';
	...
	return (
		<div className={`${classes.sidebarContainer}`}>
			<div className={`cardComponent ${classes.sidebarComponent}`}>
				...
				{/* <a href="http://localhost:3001/profile" className={`${classes.sidebarLink}`}>
                  <UilSetting className={`${classes.iconSmaller}`} />
				...
				{/* <a href=""></a> */}
				<a href="http://localhost:3001/logout" className={`${classes.sidebarLink}`}>
                  <UilSetting className={`${classes.iconSmaller}`} />
                  <div className={`${classes.hide}`}>Back to Home</div>
                </a>
